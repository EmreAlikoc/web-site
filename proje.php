...
<html lang="tr">
  ...
  <body>
    ...
    <div id="main">
      ...
      <div id="kesfet">
        <a href="#kesfetpoint">Keşfetmeye Başla!</a>
      </div>
      <p></p>
    </div>

    <div id="arabosluk">
      <img src="img/kuş logo tek.png" alt="">

    </div>
                                              <!--sandalye-->
    <div class="mainurun" id="kesfetpoint">
      <div class="urunyazi_l" id="sand">
        <h1>SANDALYELER</h1>
  
        <p>Ahşap sandalyelerimiz, doğanın sunduğu zarafeti evinize taşır, doğal ve şık bir atmosfer oluşturur.</p>
  
      </div>

      <div class="urunfoto" id="sanddd">
        <a href="sandalyeler_katalog.php"><img src="img/sandalye kapak.jpeg" alt=""></a>  
    ...
    <div class="mainurun">
      <div class="urunfoto" id="masss">
        <a href="masalar_katalog.php"><img src="img/masafoto kare.jpg" alt=""></a>  
        
      </div>
      
      <div class="urunyazi_r" id="mass">
        <h1>MASALAR</h1>
        
        <p>Ahşap masalarımız, doğanın sunduğu zarafeti sofranıza taşır, doğal ve şık bir atmosfer yaratır.</p>
                                                ...
                                                <!--koltuklar-->
    <div class="mainurun">
      <div class="urunyazi_l" id="koltt">
        <h1>KOLTUKLAR</h1>
  
        <p>Ahşabın doğal dokusu ve sıcaklığı, evinize sıcak ve davetkar bir hava katarak konforlu bir oturma alanı sunar.</p> <!--DEĞİŞECEK!!!!!-->
  
      </div>

      <div class="urunfoto" id="kolttt">
        <a href="koltuklar_katalog.php"><img src="img/koltuk1.jpeg" alt=""></a>  <!--snapedit yazısını sil!!!-->
                                              ...
                                              <!--raflar-->                                          
    <div class="mainurun" id="sonmainurun">
          <div class="urunfoto" id="rafff">
            <a href="raflar_katalog.php"><img src="img/raflar1.jpg" alt=""></a>  
            
          </div>
          
          <div class="urunyazi_r" id="raff">
            <h1>RAFLAR</h1>
            
            <p>Minimalist ve şık tasarımlarımız, sağlam yapılarıyla hem modern hem de dayanıklı depolama çözümleri arayanlar için ideal bir seçimdir.</p>
