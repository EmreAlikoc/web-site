...
<body>
    ...
    <div id="selamlar"><h1>Raflar</h1></div>
    

    <div class="fotomenu">
      <div class="fotokutu">
        <div class="image-container">
          <a href="merdiven_raflar.php"><img src="img/raflar/merdiven raflar/merdivenraf-1.jpg" alt="First Image" class="image first"></a>
          <a href="merdiven_raflar.php"><img src="img/raflar/merdiven raflar/merdivenraf-2.jpg" alt="Second Image" class="image second"></a>
      </div>
        <p> Ahşap Merdiven Raf</p>
      </div>

        <div class="fotokutu">
          <div class="image-container">
            <a href="ayakkabılık_raflar.php"><img src="img/raflar/ayakkabılık raflar/ayakkabılık-raf-1.jpg" alt="First Image" class="image first"></a>
            <a href="ayakkabılık_raflar.php"><img src="img/raflar/ayakkabılık raflar/ayakkabılık-raf-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Ahşap Ayakkabılık Raf</p>
        </div>

        <div class="fotokutu">
          <div class="image-container">
            <a href="modern_raflar.php"><img src="img/raflar/modern raflar/modern-raf-1.jpg" alt="First Image" class="image first"></a>
            <a href="modern_raflar.php"><img src="img/raflar/modern raflar/modern-raf-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Ahşap Modern Raf</p>
        </div>
    </div>
    <footer>
      <div id="ftmain">
