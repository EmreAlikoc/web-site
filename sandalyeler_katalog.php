...
<body>
    <header>
        <div id="bas">
          <a href="proje.php" id="logokaplama"><img id="logoheader" src="img/logo header 3.png" alt=""></a>  <!--ahşap yakınlaşacak--> <!--emreye renk değişimi sor!!-->
          <a id="ana" class="hdr" href="proje.php">Ana Sayfa</a> <!--animasyonlu aşağı geçiş olacak-->
          ...
          <a id="hakk" class="hdr" href="#hakkımda">Hakkımda</a> 
    ...
    <div id="selamlar"><h1>Sandalyeler</h1></div>
    

    <div class="fotomenu">
      <div class="fotokutu">
        <div class="image-container">
          <a href="teklisandalyeuzun.php"><img src="img/tekliler-1.jpeg" alt="First Image" class="image first"></a>
          <a href="teklisandalyeuzun.php"><img src="img/tekliler-2.jpeg" alt="Second Image" class="image second"></a>
      </div>
        <p>Tekli Ahşap Sandalye Uzun</p>
      </div>

        <div class="fotokutu">
          <div class="image-container">
            <a href="teklisanlyekısa.php"><img src="img/teklisandalye2-1.jpg" alt="First Image" class="image first"></a>
            <a href="teklisanlyekısa.php"><img src="img/teklisandalye2-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Tekli Ahşap Sandalye Kısa</p>
        </div>

        <div class="fotokutu">
          <div class="image-container">
            <a href="sallanansandalye.php"><img src="img/salsandalye-1.jpg" alt="First Image" class="image first"></a>
            <a href="sallanansandalye.php"><img src="img/salsandalye-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Sallanan Sandalye</p>
        </div>
    </div>
