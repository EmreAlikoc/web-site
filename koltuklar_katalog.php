...
<body>
    ...
    <div id="selamlar"><h1>Koltuklar</h1></div>
    

    <div class="fotomenu">
      <div class="fotokutu">
        <div class="image-container">
          <a href="duzkoltuk.php"><img src="img/koltuklar/düz koltuklar ikili/düzkoltuk-1.jpg" alt="First Image" class="image first"></a>
          <a href="duzkoltuk.php"><img src="img/koltuklar/düz koltuklar ikili/düzkoltuk-2.jpg" alt="Second Image" class="image second"></a>
      </div>
        <p> Ahşap Düz Koltuk</p>
      </div>

        <div class="fotokutu">
          <div class="image-container">
            <a href="Lkoltuk.php"><img src="img/koltuklar/Lkoltuklar ikili/L koltuk-1.jpg" alt="First Image" class="image first"></a>
            <a href="Lkoltuk.php"><img src="img/koltuklar/Lkoltuklar ikili/L koltuk-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Ahşap L Koltuk</p>
        </div>
        ...
        <div class="fotokutu">
          <div class="image-container">
            <a href="sallanankoltuk.php"><img src="img/koltuklar/sallanan koltuk ikili/salkoltuk-1.jpg" alt="First Image" class="image first"></a>
            <a href="sallanankoltuk.php"><img src="img/koltuklar/sallanan koltuk ikili/salkoltuk-2.jpg" alt="Second Image" class="image second"></a>
        </div>
          <p>Ahşap Sallanan Koltuk</p>
        </div>
    </div>
