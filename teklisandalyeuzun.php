...
<head>
    ...
    <title>Tekli Sandalye Uzun</title>
            ...
            <div>
              ...
              <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                  ...
                  <img src="img/tekliler-1.jpeg" style="width:100%">
                  
                </div>
              
                <div class="mySlides fade">
                  <div class="numbertext">2 / 3</div>
                  <img src="img/tekliler-2.jpeg" style="width:100%">
                  
                </div>
              
                <div class="mySlides fade">
                  <div class="numbertext">3 / 3</div>
                  <img src="img/tekliler2-3.jpg" style="width:100%">
...
<script>
  document.getElementById('signIn').addEventListener('signIn', function(event) {
    ...
    .then(data => {
      if(data.trim() === 'sucess') {
        // Giriş başarılıysa modalı kapat, kullanıcı adını göster ve Giriş Yap butonunu gizle
